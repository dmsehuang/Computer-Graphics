...
{
    // hhj - the painter may not be used
    // hhj - compiler will not create warning
    Q_UNUSED(painter);
...
/* hhj - once window visibility is changed, this event will be called */
